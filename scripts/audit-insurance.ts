...
import { getServiceQuestionSet, buildServiceRundown, SERVICE_PRICING_MAP } from "../src/features/service-intake";
...
const checks = [
  ...
  ["rundown reports required fields", rundown.missingRequiredFields.length === blueprint.requiredFields.length],
  ...
  ["claims and policy support choices", questions.some((question) => question.id === "insuranceRequestType")],
] as const;
