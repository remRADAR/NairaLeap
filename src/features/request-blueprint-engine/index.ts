...
export const REQUEST_BLUEPRINT_MAP: Record<string, RequestBlueprint> = {
  ...
  mortgage: {
    serviceId: "mortgage",
    outputTitle: "Mortgage Service Request",
    summaryTemplate:
    ...
    requiredFields: [
      ...
      {
        id: "mortgage-request-type",
        key: "mortgageRequestType",
        label: "What mortgage help do you need?",
        type: "single-choice",
        required: true,
      },
      {
        ...
        label: "Which applicant profile best describes you?",
        type: "single-choice",
        required: true,
      },
      {
        id: "property-stage",
        key: "propertyStage",
        label: "What stage is the property or project at?",
        type: "single-choice",
        required: true,
      },
      {
        id: "property-type",
        key: "propertyType",
        label: "What type of property or project is involved?",
        type: "single-choice",
        required: true,
      },
      {
        id: "mortgage-location",
        key: "mortgageLocation",
        label: "Where is the property or project located?",
        type: "location",
        required: true,
      },
      {
      ...
      },
      {
        id: "mortgage-need",
        key: "mortgageNeed",
        label: "Tell us about the housing-finance need",
        type: "long-text",
        required: true,
      },
    ],
    optionalFields: [
      {
        id: "income-range",
        key: "incomeRange",
        label: "Broad monthly income range",
        type: "single-choice",
        required: false,
      },
      {
        id: "requested-amount",
        key: "requestedAmount",
        label: "Requested finance amount, if known",
        type: "currency",
        required: false,
      },
      {
        id: "property-value",
        key: "propertyValue",
        label: "Property or project value, if known",
        type: "currency",
        required: false,
      },
      {
        id: "deposit-amount",
        key: "depositAmount",
        label: "Deposit or personal contribution, if known",
        type: "currency",
        required: false,
      },
      {
        id: "existing-mortgage-balance",
        key: "existingMortgageBalance",
        label: "Existing mortgage balance, if applicable",
        type: "currency",
        required: false,
      },
      {
        id: "mortgage-status",
        key: "mortgageStatus",
        label: "Current mortgage status, if applicable",
        type: "single-choice",
        required: false,
      },
      {
        id: "nhf-preference",
        key: "nhfPreference",
        label: "Should we consider an NHF / FMBN pathway?",
        type: "single-choice",
        required: false,
      },
      {
    ...
    requiredDocuments: [
      {
        ...
        required: false,
        description: "May be requested for identity verification by an authorized partner.",
      },
      {
        documentTypeId: "proof-of-address",
        required: false,
        description: "May support location and residency review where applicable.",
      },
      {
        documentTypeId: "income-evidence",
        required: false,
        description: "Income or employment evidence may be requested by the selected partner.",
      },
      {
        documentTypeId: "bank-statement",
        required: false,
        description:
          "Bank statements may be requested for affordability review by the selected partner.",
      },
      {
        documentTypeId: "property-title",
        required: false,
        description:
          "Title or offer documents may be requested for property review where applicable.",
      },
      {
        documentTypeId: "valuation-report",
        required: false,
        description: "A valuation or project document may be requested by the selected partner.",
      },
      {
        documentTypeId: "supporting-documents",
        required: false,
        description:
          "Existing mortgage, construction, developer or other supporting records where relevant.",
      },
    ],
    adminChecklist: [
      {
        id: "classify-mortgage-need",
        label: "Classify mortgage purpose and applicant pathway",
        category: "review",
      },
      {
        id: "verify-applicant-contact",
        label: "Verify requester identity and contact details before referral",
        category: "verification",
      },
      {
        id: "review-affordability-context",
        label:
          "Review income, contribution and affordability context without approving the request",
        category: "review",
      },
      {
        id: "review-property-pathway",
        label: "Review property, title, construction or developer context where applicable",
        category: "verification",
      },
      {
        id: "check-finance-partner-fit",
        label: "Check suitable verified lender, PMB, FMBN/NHF or authorized partner pathway",
        category: "compliance",
      },
      {
        id: "confirm-mortgage-next-steps",
        label: "Confirm next steps, outstanding documents and partner-review boundaries",
        category: "communication",
      },
    ],
    nextWorkflow: "guided-question-engine",
