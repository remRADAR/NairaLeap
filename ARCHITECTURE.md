...
**Backend boundary:** Supabase Auth, Postgres, Storage, and server functions through the project’s Supabase environment
...
| ----------------------------------------------- | ---------------------------------------------------------------------------------------------------------- | ----------------------------- |
| Live Supabase project and environment ownership | Configure the connected Supabase project and keep secrets outside Git                                      | **UNVERIFIED**                |
